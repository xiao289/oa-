            ...
            <form action="" name="formx" method="post">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table">
                ...
                <c:forEach items="${pi.list}" var="t">
                   ...
                   <td>
                       <a href="/resource/myself/demo4/getTaskLook?userid=${t.userid}&typeall=${t.typeall}&taskid=${t.taskid}">${t.name}</a>
                   </td>
				     ...
				     <div class="page mt10">
						<div class="pagination">
						  <ul >
                              ...
                              <page:page pageSize="${pi.size}" historical="" method="starttime=${starttime}&subtime=${subtime}&typeall=${typeall}" url="/resource/myself/demo4/getTask" currentPage="${pi.pageNum}" count="${pi.total}"/>
