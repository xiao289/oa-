 ...
 <head>
   ...
   <script type="text/javascript" src="../../../js/common.js"></script>
     ...
     <script type="text/javascript"  >
         var oid=0,q1=0,q2=0,q3=0,q4=0,q5=0,q6=0,q7=0,q8=0;
         $(function () {
       ...
       */
         ...
         function tijiao() {
             ...
             if (oid == 1 && q1 == 1 && q2 == 1 && q3 == 1 &&  q4 == 1 && q5 == 1 && q6 == 1 && q7 == 1 && q8 == 1) {
        ...
        <div class="box">
          <div class="box_border">
            ...
            <div class="box_center">
              <form action="/resource/system/user/adduser"  class="jqtransform" method="post" enctype="multipart/form-data" >
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">

                 <tr>
                  <td class="td_right">登录名：</td>
                  <td class=""> 
                    <input type="text" name="loginname" class="input-text lh30" size="40"><span style="color: red"></span>
                  </td>
				  </tr>
				  <tr>
                  <td class="td_right">密码：</td><td>
                      <input type="password" name="password" class="input-text lh30" size="40"><span style="color: red"></span>
                  </td>
                </tr>
					   <tr>
					   ...
					   <tr>
						  ...
						  <td class=""> 
							<input type="text" name="idcard" class="input-text lh30" size="40"><span style="color: red"></span>
						  </td>
					  </tr>
					   <tr>
						  <td class="td_right">年龄：</td>
						  <td class=""> 
							<input type="text" name="age" class="input-text lh30" size="10">
						  </td>
					  </tr>
                                          <tr>
						  <td class="td_right">手机号：</td>
						  <td class=""> 
							<input type="text" name="phone" class="input-text lh30" size="10"><span style="color: red"></span>
						  </td>
					  </tr>
				<tr>
                  <td class="td_right">性别：</td>
                  <td class="">
                    <input type="radio" name="sex"  id="sexman"  value="0"> 男
                    <input type="radio" name="sex" id="sexwomen" value="1"> 女
                  </td>
				  </tr>
                ...
                <tr>
                  ...
                  <td class=""><input type="file" name="photo1" class="input-text lh30" size="10"></td>
                 </tr>
               <tr>
                  <td class="td_right">状态：</td>
                  <td class="">
                    <input type="radio" name="state" checked value="0"> 启用
                    <input type="radio" name="state" value="1"> 冻结
                  </td>
				  </tr>

                   <input type="hidden" name="username" value="${loginname.loginname}">
                   <input type="hidden" name="event" value="添加用户">
                   <textarea style="visibility: hidden" hidden name="remark" cols="30" rows="10" class="textarea">无</textarea>


                 <tr>
                   <td class="td_right">&nbsp;</td>
                   <td class="">
                     <input type="button" class="btn btn82 btn_save2" onclick="tijiao()" value="提交">
                    <input type="button" name="button" class="btn btn82 btn_res" onclick="location.href='javascript:history.go(-1)'" value="返回"> <span style="color: red"></span>
                   </td>
                 </tr>
               </table>
               </form>
