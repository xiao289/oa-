...
<head>
    ...
    <script type="text/javascript">
        function del(id){
            var val = $("[name=username]").val();
            var str=confirm("确认删除");
            if (str==true){
                location.href="/resource/xingzheng/demo2/deletecarbyid?id="+id+"&username="+val;
            }
        }
        function delall() {
...
<div  class="box_bottom pb5 pt5 pr10" style="border-top:1px solid #dadada;">
    <div class="search_bar_btn" style="text-align:left;" >
        <a href="/resource/xingzheng/demo2/toyuding" class="ext_btn"><span class=""></span>用车预定</a>
    </div>
</div>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table">
                ...
                <c:forEach items="${pa.list}" var="clist">
                    <tr class="tr" align="center">
                        ...
                        <td>
                            <a href="/resource/xingzheng/demo2/getcarbyid?id=${clist.id}&username=${loginname.loginname}&remark='无'&event='编辑车辆信息'">编辑</a> |&nbsp;
