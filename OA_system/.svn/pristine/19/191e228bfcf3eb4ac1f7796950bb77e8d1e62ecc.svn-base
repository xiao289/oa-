              ...
              <form action="list.jsp" class="jqtransform">
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                 <tr>
				  ...
				  <td><fmt:formatDate value='${a1.starttime}' pattern='yyyy/MM/dd'/>to
                      <fmt:formatDate value='${a1.endtime}' pattern='yyyy/MM/dd'/></td>
                </tr>
					   <tr>
						  <td class="td_right">发布时间：</td>
						  <td class="">
                              <fmt:formatDate value='${a1.suntime}' pattern='yyyy/MM/dd'/>
						  </td>
					  </tr>
					   <tr>
